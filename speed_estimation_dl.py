# -*- coding: utf-8 -*-
"""
Created on Wed Apr 20 11:45:10 2022
...
ap.add_argument("-s", "--vidsrc", required=True, help="Path to video source", type=str, default=0)
...
#vs = VideoStream(src=args["vidsrc"]).start()
#vs = VideoStream(usePiCamera=True).start()
vs=cv2.VideoCapture(args["vidsrc"])
time.sleep(2.0)
    ...
    if totalFrames % conf["track_object"] == 0:
        ...
        for i in np.arange(0, detections.shape[2]):
            ...
            if confidence > conf["confidence"]:
                ...
                if CLASSES[idx] != "car" and "motorbike" and "bus":
                    continue
